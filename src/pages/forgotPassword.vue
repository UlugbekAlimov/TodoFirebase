<template>
  <v-form class="d-flex justify-center align-center w-100 h-100">
    ...
    <div class="d-flex flex-column ga-4">
      <v-text-field v-model="email" label="Email" variant="outlined" hide-details></v-text-field>
      <router-link to="/login" style="padding-right: 10px; text-decoration: none; color: blue;">Back to login</router-link>
    </div>
